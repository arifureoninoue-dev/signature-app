...
# (TRANSLATIONSとJAPANESE_TEXTのデータは長いため、ここでは省略します)
# ... (TRANSLATIONSとJAPANESE_TEXTのデータは元のコード通り) ...
